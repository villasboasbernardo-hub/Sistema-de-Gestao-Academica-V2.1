...
REGISTROS_AULA = MapaDeTabela(
    ...
    colunas=(
        ...
        C("ID_Grade", "disciplina_id", T.FK, "disciplinas"),
        C(None, "unidade_ensino_id", T.DERIVADA, "⚠️ do cruzamento v1.0 (etapa 2-B). NULO quando o veredito nao for `casado` — amparado pelo CHECK do FR-025.8"),
