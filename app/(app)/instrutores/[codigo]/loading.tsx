/**
 * Carregamento da ficha do instrutor (`RN-DEG-01`, `FR-045` da spec 008).
 *
...
export default function CarregandoFichaDoInstrutor() {
  return (
    <div aria-busy="true" aria-live="polite" className="flex flex-col gap-3">
      <span className="sr-only">Carregando a ficha do instrutor…</span>
