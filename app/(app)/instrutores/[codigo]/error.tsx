/**
 * Contenção de erro da ficha do instrutor (`RN-DEG-01`, Princípio V).
 *
...
export default function ErroNaFichaDoInstrutor({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[CIAARA-11] falha na ficha do instrutor:", error);
  }, [error]);
