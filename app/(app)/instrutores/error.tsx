/**
 * Contenção de erro do segmento de instrutores (`RN-DEG-01`, Princípio V).
 *
...
export default function ErroEmInstrutores({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[CIAARA-11] falha em instrutores:", error);
  }, [error]);
