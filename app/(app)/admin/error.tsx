/**
 * Contenção de erro do segmento de administração (`FR-020`, `RN-DEG-01`, Princípio V).
 *
...
export default function ErroNaAdministracao({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[CIAARA-11] falha na administração:", error);
  }, [error]);
