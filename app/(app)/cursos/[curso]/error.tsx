/**
 * Contenção de erro da página do curso (`RN-DEG-01`, Princípio V).
 *
 * ⚠️ **A FALHA DE UMA TELA NÃO DERRUBA A CASCA.** A pessoa continua com cabeçalho, menu e sessão.
 */
"use client";
...
export default function ErroNoCurso({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[CIAARA-11] falha na página do curso:", error);
  }, [error]);
