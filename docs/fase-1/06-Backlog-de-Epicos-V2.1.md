...
| **TURMA-1** | Status "Arquivada" no domínio de turma | Baixo | **Épico 1** (barato agora, migration depois) | Se for filtro de apresentação sobre turmas concluídas antigas, resolver como VIEW e **não** criar valor no `ENUM` |
