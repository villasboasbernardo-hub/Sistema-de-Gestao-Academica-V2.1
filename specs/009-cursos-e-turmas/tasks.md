...
- [X] T207 [PR2] `pnpm verificar:tudo` saindo 0 e o CI com **o mesmo veredito** sobre o mesmo commit (`FR-046.1`, `SC-009`) ⛓ T128 a T206 ✅ **CONFERIDA E APROVADA POR BERNARDO VILLAS BOAS em 24/09/2026** — Parte A no banco local, incluindo criar e editar curso **pelos botões novos**, e Parte B no preview. `pnpm verificar:tudo` e o CI deram o mesmo veredito sobre o mesmo commit.
