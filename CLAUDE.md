...
| **Épico 0 — Fundação** | 🟨 **65 de 72 tarefas** (07/09/2026) — **ainda NÃO fechado**, e falta pouco. Fechados: CI verde nos três contextos, proteção da `main` com `enforce_admins=true`, **PR #1 mesclado**, varredura de segredos e proteção de push **ligadas**, preview no ar e conferida por Bernardo (T053, T054, T056). **Falta o que só se prova quebrando de propósito:** T048 (o bloqueio de merge nas quatro formas de defeito), T049 (coincidência local × CI sobre os mesmos commits), T042 (o portão do contrato de dados reprovando), T055 (atomicidade do deploy) e T057/T058. ⚠️ **T052 REGREDIU**: a `service_role` foi cadastrada em Production e Preview na Vercel em 07/09, o que derruba o SC-007, o FR-016.1 e o V-9 — ver a nota em `contracts/variaveis-ambiente.md` |
