...
| **PR-4c** | **Mesclar o PR #10**, o da fatia (c) — verde em `qualidade`, `banco` e `build`. O **PR #9** (redirecionamento aberto) **já foi mesclado** em 11/09/2026 | Fecha o Épico 4. É a única pendência que resta da fatia |
